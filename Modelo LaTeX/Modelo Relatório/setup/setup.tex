...
% New glossary with NAME-TITLE-FILETYPE-TEXTNAME
\newglossary{simbolos}{simbolos}{sbl}{simbolos}

% Acronym creation: \siglalista{acronym}{meaning}
\newcommand{\siglalista}[2]{\newacronym{#1}{#1}{#2}}

% Glossary input creations: \simbololist{identification}{name}{description}
